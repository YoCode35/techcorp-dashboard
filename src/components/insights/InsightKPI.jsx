...
function InsightKPI({ label, value, sub, trend, trendLabel, icon: Icon, iconBg, progress, gradient, className }) {
    ...
    return (
        <div className={clsx(
            ...
            <div className={clsx(
                'absolute inset-0 bg-gradient-to-br via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none',
